    ...
    <div>
      ...
      <div className="table-responsive">
        {campaignList && campaignList.length > 0 ? (
            ...
            <tbody>
              {campaignList.map((campaign, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{campaign.start ? <TextFormat type="date" value={campaign.start} format={APP_DATE_FORMAT} /> : null}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/campaign/${campaign.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">No Campaigns found</div>
        )}
      </div>
      {totalItems ? (
